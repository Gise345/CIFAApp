            ...
            {goalsStats.map((team, index) => (
              <View key={team.teamId} style={styles.statItem}>
                <View style={styles.statLabel}>
                  <Text style={styles.statLabelText}>{team.teamName}</Text>
                </View>
                <View style={styles.statValue}>
                  ...
                  />
                  <Text style={styles.statValueText}>({team.value})</Text>
                </View>
            ...
            {defenseStats.map((team, index) => (
              <View key={team.teamId} style={styles.statItem}>
                ...
                <View style={styles.statValue}>
                  ...
                  />
                  <Text style={styles.statValueText}>({getDefenseLabel(team.value)})</Text>
                </View>
                <View style={styles.statBar}>
                  <View 
                    style={[
