      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView style={styles.content}>
          <View style={styles.headerSection}>
            <Text style={styles.titleText}>Leagues</Text>
            <Button 
              title="Add League" 
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>League management coming soon</Text>
            <Text style={styles.emptySubtext}>
              This feature will allow you to create and manage leagues, divisions, and competitions.
            </Text>
          </View>
        </ScrollView>
      </SafeAreaView>
