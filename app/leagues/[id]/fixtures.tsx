...
export default function LeagueFixturesScreen() {
  ...
  const navigateToResults = () => {
    router.push(`/leagues/${leagueId}/results`);
  };
        ...
        <ScrollView style={styles.content}>
          ...
          <View style={styles.leagueHeaderContainer}>
            <Text style={styles.leagueName}>
              {selectedLeague?.name || 'League Fixtures'}
            </Text>
          ...
          <View style={styles.tabsContainer}>
            <View style={[styles.tab, styles.activeTab]}>
              <Text style={[styles.tabText, styles.activeTabText]}>FIXTURES</Text>
            </View>
            <TouchableOpacity 
              style={styles.tab}
