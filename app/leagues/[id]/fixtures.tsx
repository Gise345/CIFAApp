  ...
  return (
    ...
    >
      <SafeAreaView style={styles.safeArea}>
        <Header title="Upcoming Fixtures" showBack={true} />
        <ScrollView style={styles.content}>
          <Section title={leagueName.toUpperCase()} style={styles.section}>
            <Card>
              <Text style={styles.upcomingText}>Upcoming Fixtures</Text>
              
              {/* This would be replaced with a proper fixtures component */}
              <View style={styles.placeholder}>
                <Text style={styles.placeholderText}>Fixtures for {leagueName} will appear here</Text>
              </View>
            </Card>
          </Section>
        </ScrollView>
